...
SCHEMA = get_schema_file('categorized-tags.schema.json').read()
SYSTEM_MESSAGE = (
...
async def query_opportunity_tags(
    client: AsyncOpenAI,
    html: str,
    ...
    *,
    ...
    task, start_time = start_query('Querying tags for opportunity', opportunity_id)
    ...
    end_query('Done querying tags for opportunity', start_time, task, opportunity_id)
