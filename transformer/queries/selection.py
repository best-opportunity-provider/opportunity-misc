...
SCHEMA = get_schema_file('selection.schema.json').read()
SYSTEM_MESSAGE = (
...
async def query_opportunity_selection_info(
    ...
    *,
    ...
    task, start_time = start_query('Querying selection info for opportunity', opportunity_id)
    ...
    end_query('Done querying selection info for opportunity', start_time, task, opportunity_id)
