...
SCHEMA = get_schema_file('form.schema.json').read()
SYSTEM_MESSAGE = (
...
async def query_opportunity_form(
    client: AsyncOpenAI,
    html: str,
    ...
    *,
    ...
    task, start_time = start_query('Querying form for opportunity', opportunity_id)
    ...
    end_query('Done querying form for opportunity', start_time, task, opportunity_id)
