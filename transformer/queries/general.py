...
SCHEMA = get_schema_file('general.schema.json').read()
SYSTEM_MESSAGE = (
...
async def query_opportunity_general_info(
    client: AsyncOpenAI,
    html: str,
    ...
    *,
    ...
    task, start_time = start_query('Querying general info for opportunity', opportunity_id)
    ...
    end_query('Done querying general info for opportunity', start_time, task, opportunity_id)
